...
const STORAGE_KEY = "tl_capital";
const STORAGE_VALUE = "granted";
const ACCESS_CODE = "givemeyourmoney";
const FONT = "'Plus Jakarta Sans', system-ui, sans-serif";

interface CapitalGateProps {
  children: ReactNode;
}

const CapitalGate = ({ children }: CapitalGateProps) => {
      ...
      >
        <div
          style={{
            ...
            alignItems: "center",
            textAlign: "center",
            animation: shake ? "tl-cap-shake 0.3s ease" : undefined,
          }}
        >
          <div
            style={{
          ...
          {error && (
            <div
              style={{
                ...
                color: "#DC2626",
                marginTop: 8,
                animation: "tl-cap-fade-in 0.2s ease",
