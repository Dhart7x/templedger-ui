...
const staticExceptions: Exception[] = [
  { id: "ISS001", type: "Compliance", agency: "Staffline", worker: "David Chen", department: "Warehouse Operative", site: "Ellesmere Port", trigger: "Right to Work expired", owner: null, status: "open", priority: "P1", createdAt: "06:15", workerId: "W004" },
  { id: "ISS002", type: "Compliance", agency: "Staffline", worker: "Robert Taylor", department: "Warehouse Operative", site: "Ellesmere Port", trigger: "H&S certification expired", owner: null, status: "open", priority: "P1", createdAt: "06:18", workerId: "W008" },
  { id: "ISS003", type: "Pending Verification", agency: "Staffline", worker: "James Cooper", department: "Warehouse Operative", site: "Ellesmere Port", trigger: "Right to Work pending", owner: "Sarah Mitchell", status: "in-review", priority: "P2", createdAt: "Yesterday", workerId: "W002" },
  { id: "ISS004", type: "Late Arrival", agency: "Staffline", worker: "Lisa Anderson", department: "Warehouse Operative", site: "Ellesmere Port", trigger: "Late clock-in (12 mins)", owner: null, status: "open", priority: "P2", createdAt: "14:30", workerId: "W007" },
];
