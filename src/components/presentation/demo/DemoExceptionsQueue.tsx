            ...
            <div className="w-full space-y-4">
              ...
              {!resolution.acknowledged && resolution.clientResponse !== "accepted" && (
                <div className="flex gap-3">
                  <Button
                    ...
                    onClick={() => handleClientResponse(selectedException.id, "request-replacement")}
                  >
                  ...
                  <Button
                    className="flex-1 gap-2"
                    onClick={() => handleClientResponse(selectedException.id, "accepted")}
                  >
              ...
              {resolution.acknowledged && (
                <div className="p-3 rounded-lg bg-primary/10 border border-primary/20 text-center">
                  <span className="text-sm font-medium text-primary">Resolution Accepted</span>
                </div>
              )}
            </div>
          ) : (
              ...
              return (
                <tr
                  ...
                  className={`border-t border-border hover:bg-muted/30 transition-colors cursor-pointer ${
                    resolution && !resolution.acknowledged ? "bg-primary/5" : ""
                  }`}
                >
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      ...
                      {resolution
                        ? (resolution.resolutionType === "on-the-way" ? "On Way" : "Replaced")
