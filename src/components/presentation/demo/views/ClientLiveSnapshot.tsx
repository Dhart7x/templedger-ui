...
const sites: SiteData[] = [
  {
    ...
    overtime: 8,
    agencies: [
      { name: "Staffline", workers: 52 },
      { name: "Pertemps", workers: 28 },
      { name: "Blue Arrow", workers: 12 },
    ],
    departments: [
      { name: "Warehouse", required: 38, filled: 37, confidence: 97 },
      { name: "Picking", required: 25, filled: 24, confidence: 96 },
      { name: "Loading", required: 20, filled: 19, confidence: 95 },
      { name: "Packing", required: 12, filled: 12, confidence: 100 },
    ],
  },
  {
    id: "2",
    ...
    overtime: 4,
    agencies: [
      { name: "Staffline", workers: 42 },
      { name: "Blue Arrow", workers: 28 },
    ],
    departments: [
      { name: "Warehouse", required: 30, filled: 29, confidence: 97 },
      { name: "Picking", required: 22, filled: 22, confidence: 100 },
      { name: "Loading", required: 12, filled: 11, confidence: 92 },
      { name: "Quality", required: 8, filled: 8, confidence: 100 },
    ],
  },
  {
    id: "3",
    ...
    overtime: 3,
    agencies: [
      { name: "Pertemps", workers: 38 },
      { name: "Staffline", workers: 26 },
    ],
    departments: [
      { name: "Warehouse", required: 28, filled: 26, confidence: 93 },
      { name: "Picking", required: 20, filled: 19, confidence: 95 },
      { name: "Loading", required: 14, filled: 13, confidence: 93 },
      { name: "Packing", required: 6, filled: 6, confidence: 100 },
    ],
  },
];
