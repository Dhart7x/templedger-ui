...
const agencySpend: AgencySpendData[] = [
  {
    ...
    sites: [
      { name: "Baltimore, MD", amount: 55500, hours: 4440, departments: [{ name: "Inbound Warehouse", amount: 33300, hours: 2664, overtimeHours: 266 }, { name: "MHE", amount: 22200, hours: 1776, overtimeHours: 178 }] },
      { name: "Las Vegas, NV", amount: 30600, hours: 2448, departments: [{ name: "Inbound Warehouse", amount: 18360, hours: 1469, overtimeHours: 147 }, { name: "MHE", amount: 12240, hours: 979, overtimeHours: 98 }] },
      { name: "Dallas Fort-Worth, TX", amount: 11100, hours: 888, departments: [{ name: "Inbound Warehouse", amount: 6660, hours: 533, overtimeHours: 53 }, { name: "MHE", amount: 4440, hours: 355, overtimeHours: 36 }] },
    ],
  },
  {
    ...
    sites: [
      { name: "Baltimore, MD", amount: 25200, hours: 2016, departments: [{ name: "Inbound Warehouse", amount: 15120, hours: 1210, overtimeHours: 121 }, { name: "MHE", amount: 10080, hours: 806, overtimeHours: 81 }] },
      { name: "Dallas Fort-Worth, TX", amount: 29400, hours: 2352, departments: [{ name: "Inbound Warehouse", amount: 17640, hours: 1411, overtimeHours: 141 }, { name: "MHE", amount: 11760, hours: 941, overtimeHours: 94 }] },
    ],
  },
  {
    ...
    sites: [
      { name: "Baltimore, MD", amount: 9600, hours: 768, departments: [{ name: "Inbound Warehouse", amount: 5760, hours: 461, overtimeHours: 46 }, { name: "MHE", amount: 3840, hours: 307, overtimeHours: 31 }] },
      { name: "Las Vegas, NV", amount: 17100, hours: 1368, departments: [{ name: "Inbound Warehouse", amount: 10260, hours: 821, overtimeHours: 82 }, { name: "MHE", amount: 6840, hours: 547, overtimeHours: 55 }] },
    ],
  },
];
