...
const payrollItems: PayrollItem[] = [
  ...
  { id: "3", worker: "Sarah Mitchell", agency: "Meridian Recruitment", department: "MHE", hoursWorked: 45, hoursApproved: 40, payRate: 14.00, chargeRate: 21.00, status: "at-risk", issues: ["5 overtime hours pending approval"] },
  ...
  { id: "5", worker: "Fatima Al-Hassan", agency: "Workforce Direct", department: "MHE", hoursWorked: 36, hoursApproved: 0, payRate: 12.50, chargeRate: 18.75, status: "blocked", issues: ["Late arrival dispute unresolved", "Timesheet not signed off"] },
  ...
  { id: "7", worker: "Daniel Reeves", agency: "Meridian Recruitment", department: "MHE", hoursWorked: 0, hoursApproved: 0, payRate: 12.00, chargeRate: 18.00, status: "blocked", issues: ["No-show - no hours to process"] },
