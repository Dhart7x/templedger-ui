...
export const agencyWorkers: AgencyWorker[] = [
  ...
  { id: "AW002", name: "Rico Fernandez", agencyId: "AG001", status: "deployed", department: "MHE Operations", location: "Zone B", currentShift: "06:00–14:00", executionStatus: "on-track", registeredDate: "2024-01-18", complianceStatus: "verified", distanceMiles: 3.8, etaMinutes: 15, hourlyRate: 14.50, completedShifts: 142, punctualityScore: 94, rating: 4.6 },
  { id: "AW003", name: "Fatima Al-Hassan", agencyId: "AG001", status: "deployed", department: "Pick and Pack", location: "Zone C", currentShift: "14:00–22:00", executionStatus: "at-risk", registeredDate: "2024-03-05", complianceStatus: "verified", distanceMiles: 5.1, etaMinutes: 20, hourlyRate: 12.50, completedShifts: 98, punctualityScore: 78, rating: 3.8 },
  { id: "AW004", name: "Emma Johansson", agencyId: "AG001", status: "deployed", department: "Outbound Dispatch", location: "Zone A", currentShift: "06:00–14:00", executionStatus: "on-track", registeredDate: "2023-11-22", complianceStatus: "verified", distanceMiles: 1.6, etaMinutes: 5, hourlyRate: 12.80, completedShifts: 210, punctualityScore: 97, rating: 4.9 },
  ...
  // Active (4)
  { id: "AW007", name: "Marcus Webb", agencyId: "AG001", status: "active", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2024-05-20", complianceStatus: "verified", distanceMiles: 6.5, etaMinutes: 25, hourlyRate: 12.00, completedShifts: 56, punctualityScore: 88, rating: 4.1 },
  { id: "AW008", name: "Fatima Al-Hassan", agencyId: "AG001", status: "active", department: "MHE Operations", location: "Zone B", currentShift: null, executionStatus: "on-track", registeredDate: "2024-06-01", complianceStatus: "verified", distanceMiles: 2.8, etaMinutes: 10, hourlyRate: 14.20, completedShifts: 48, punctualityScore: 92, rating: 4.4 },
  ...
  { id: "AW010", name: "Marcus Webb", agencyId: "AG001", status: "active", department: "Outbound Dispatch", location: "Zone D", currentShift: null, executionStatus: "on-track", registeredDate: "2024-08-10", complianceStatus: "verified", distanceMiles: 7.2, etaMinutes: 30, hourlyRate: 12.60, completedShifts: 22, punctualityScore: 85, rating: 3.9 },
  // New Registered (3)
  ...
  { id: "AW012", name: "Ana Pereira", agencyId: "AG001", status: "new-registered", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2026-04-02", complianceStatus: "pending", distanceMiles: 4.8, etaMinutes: 20, hourlyRate: 12.00, completedShifts: 0, punctualityScore: 0, rating: 0 },
  { id: "AW013", name: "Ana Pereira", agencyId: "AG001", status: "new-registered", department: "MHE Operations", location: "Zone B", currentShift: null, executionStatus: "on-track", registeredDate: "2026-04-08", complianceStatus: "pending", distanceMiles: 5.6, etaMinutes: 20, hourlyRate: 14.00, completedShifts: 0, punctualityScore: 0, rating: 0 },
  // Blocked (2)
  ...
  // Deployed (6)
  { id: "AW016", name: "Aisha Nwosu", agencyId: "AG002", status: "deployed", department: "MHE Operations", location: "Zone B", currentShift: "06:00–14:00", executionStatus: "on-track", registeredDate: "2023-10-08", complianceStatus: "verified", distanceMiles: 1.8, etaMinutes: 5, hourlyRate: 15.00, completedShifts: 194, punctualityScore: 98, rating: 4.9 },
  ...
  { id: "AW018", name: "Leon Kowalski", agencyId: "AG002", status: "deployed", department: "Pick and Pack", location: "Zone C", currentShift: "14:00–22:00", executionStatus: "at-risk", registeredDate: "2024-02-14", complianceStatus: "verified", distanceMiles: 4.0, etaMinutes: 15, hourlyRate: 13.00, completedShifts: 112, punctualityScore: 81, rating: 3.9 },
  { id: "AW019", name: "Sarah Mitchell", agencyId: "AG002", status: "deployed", department: "Outbound Dispatch", location: "Zone D", currentShift: "22:00–06:00", executionStatus: "on-track", registeredDate: "2023-12-18", complianceStatus: "verified", distanceMiles: 3.2, etaMinutes: 15, hourlyRate: 13.80, completedShifts: 162, punctualityScore: 95, rating: 4.7 },
  ...
  // Active (4)
  { id: "AW022", name: "Maisie O'Brien", agencyId: "AG002", status: "active", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2024-05-10", complianceStatus: "verified", distanceMiles: 3.6, etaMinutes: 15, hourlyRate: 13.00, completedShifts: 64, punctualityScore: 93, rating: 4.5 },
  ...
  { id: "AW024", name: "James Okafor", agencyId: "AG002", status: "active", department: "MHE Operations", location: "Zone A", currentShift: null, executionStatus: "on-track", registeredDate: "2024-07-02", complianceStatus: "verified", distanceMiles: 1.5, etaMinutes: 5, hourlyRate: 15.00, completedShifts: 36, punctualityScore: 95, rating: 4.6 },
  { id: "AW025", name: "Aisha Nwosu", agencyId: "AG002", status: "active", department: "Outbound Dispatch", location: "Zone D", currentShift: null, executionStatus: "on-track", registeredDate: "2024-08-05", complianceStatus: "verified", distanceMiles: 5.4, etaMinutes: 20, hourlyRate: 13.80, completedShifts: 28, punctualityScore: 89, rating: 4.2 },
  // New Registered (3)
  ...
  { id: "AW028", name: "Diane Foster", agencyId: "AG002", status: "new-registered", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2026-04-10", complianceStatus: "pending", distanceMiles: 4.6, etaMinutes: 20, hourlyRate: 13.00, completedShifts: 0, punctualityScore: 0, rating: 0 },
  // Blocked (2)
  ...
  { id: "AW030", name: "Priya Sharma", agencyId: "AG002", status: "blocked", department: "MHE Operations", location: "Zone B", currentShift: null, executionStatus: "blocked", registeredDate: "2023-06-15", complianceStatus: "expired", distanceMiles: 9.2, etaMinutes: 35, hourlyRate: 15.00, completedShifts: 216, punctualityScore: 73, rating: 3.4 },
  ...
  { id: "AW032", name: "Tom Brady", agencyId: "AG003", status: "deployed", department: "Pick and Pack", location: "Zone C", currentShift: "06:00–14:00", executionStatus: "on-track", registeredDate: "2024-02-08", complianceStatus: "verified", distanceMiles: 6.0, etaMinutes: 25, hourlyRate: 11.80, completedShifts: 108, punctualityScore: 87, rating: 4.1 },
  { id: "AW033", name: "Emma Johansson", agencyId: "AG003", status: "deployed", department: "MHE Operations", location: "Zone B", currentShift: "14:00–22:00", executionStatus: "at-risk", registeredDate: "2024-01-12", complianceStatus: "verified", distanceMiles: 5.4, etaMinutes: 20, hourlyRate: 13.50, completedShifts: 130, punctualityScore: 79, rating: 3.7 },
  { id: "AW034", name: "James Okafor", agencyId: "AG003", status: "deployed", department: "Outbound Dispatch", location: "Zone D", currentShift: "06:00–14:00", executionStatus: "on-track", registeredDate: "2023-11-05", complianceStatus: "verified", distanceMiles: 7.8, etaMinutes: 30, hourlyRate: 12.20, completedShifts: 158, punctualityScore: 88, rating: 4.0 },
  ...
  // Active (4)
  { id: "AW037", name: "Sarah Mitchell", agencyId: "AG003", status: "active", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2024-05-28", complianceStatus: "verified", distanceMiles: 5.0, etaMinutes: 20, hourlyRate: 11.50, completedShifts: 44, punctualityScore: 83, rating: 3.9 },
  ...
  { id: "AW039", name: "Diane Foster", agencyId: "AG003", status: "active", department: "MHE Operations", location: "Zone A", currentShift: null, executionStatus: "on-track", registeredDate: "2024-07-10", complianceStatus: "verified", distanceMiles: 4.2, etaMinutes: 15, hourlyRate: 13.50, completedShifts: 28, punctualityScore: 81, rating: 3.8 },
  { id: "AW040", name: "Leon Kowalski", agencyId: "AG003", status: "active", department: "Outbound Dispatch", location: "Zone D", currentShift: null, executionStatus: "on-track", registeredDate: "2024-08-22", complianceStatus: "verified", distanceMiles: 10.2, etaMinutes: 40, hourlyRate: 12.00, completedShifts: 18, punctualityScore: 80, rating: 3.7 },
  // New Registered (3)
  ...
  { id: "AW042", name: "Marcus Webb", agencyId: "AG003", status: "new-registered", department: "MHE Operations", location: "Zone B", currentShift: null, executionStatus: "on-track", registeredDate: "2026-04-01", complianceStatus: "pending", distanceMiles: 7.0, etaMinutes: 30, hourlyRate: 13.00, completedShifts: 0, punctualityScore: 0, rating: 0 },
  { id: "AW043", name: "Daniel Reeves", agencyId: "AG003", status: "new-registered", department: "Pick and Pack", location: "Zone C", currentShift: null, executionStatus: "on-track", registeredDate: "2026-04-09", complianceStatus: "pending", distanceMiles: 5.8, etaMinutes: 25, hourlyRate: 11.50, completedShifts: 0, punctualityScore: 0, rating: 0 },
  // Blocked (2)
  ...
  { id: "AW045", name: "Ana Pereira", agencyId: "AG003", status: "blocked", department: "MHE Operations", location: "Zone B", currentShift: null, executionStatus: "blocked", registeredDate: "2023-05-18", complianceStatus: "expired", distanceMiles: 9.6, etaMinutes: 40, hourlyRate: 13.50, completedShifts: 190, punctualityScore: 72, rating: 3.4 },
];
...
export const agencyDeployments: AgencyDeployment[] = [
  ...
  { id: "DEP002", workerId: "AW002", workerName: "Rico Fernandez", department: "MHE Operations", location: "Zone B", shiftStart: "06:00", shiftEnd: "14:00", status: "on-site", attendanceStatus: "clocked-in" },
  { id: "DEP003", workerId: "AW003", workerName: "Fatima Al-Hassan", department: "Pick and Pack", location: "Zone C", shiftStart: "14:00", shiftEnd: "22:00", status: "scheduled", attendanceStatus: "pending" },
  { id: "DEP004", workerId: "AW004", workerName: "Emma Johansson", department: "Outbound Dispatch", location: "Zone A", shiftStart: "06:00", shiftEnd: "14:00", status: "on-site", attendanceStatus: "clocked-in" },
  ...
  // Pinnacle Staffing (6)
  { id: "DEP007", workerId: "AW016", workerName: "Aisha Nwosu", department: "MHE Operations", location: "Zone B", shiftStart: "06:00", shiftEnd: "14:00", status: "on-site", attendanceStatus: "clocked-in" },
  ...
  { id: "DEP009", workerId: "AW018", workerName: "Leon Kowalski", department: "Pick and Pack", location: "Zone C", shiftStart: "14:00", shiftEnd: "22:00", status: "scheduled", attendanceStatus: "pending" },
  { id: "DEP010", workerId: "AW019", workerName: "Sarah Mitchell", department: "Outbound Dispatch", location: "Zone D", shiftStart: "22:00", shiftEnd: "06:00", status: "scheduled", attendanceStatus: "pending" },
  ...
  { id: "DEP014", workerId: "AW032", workerName: "Tom Brady", department: "Pick and Pack", location: "Zone C", shiftStart: "06:00", shiftEnd: "14:00", status: "on-site", attendanceStatus: "clocked-in" },
  { id: "DEP015", workerId: "AW033", workerName: "Emma Johansson", department: "MHE Operations", location: "Zone B", shiftStart: "14:00", shiftEnd: "22:00", status: "scheduled", attendanceStatus: "pending" },
  { id: "DEP016", workerId: "AW034", workerName: "James Okafor", department: "Outbound Dispatch", location: "Zone D", shiftStart: "06:00", shiftEnd: "14:00", status: "completed", attendanceStatus: "clocked-out" },
...
export const allocations: Allocation[] = [
  ...
  { id: "ALLOC002", department: "Pick and Pack", location: "Zone C", role: "Pick and Pack", date: "Mon 3 Feb", shift: "14:00–22:00", requestedHeadcount: 3, assignedWorkers: [{ workerId: "AW003", workerName: "Fatima Al-Hassan", status: "confirmed" }, { workerId: "AW007", workerName: "Marcus Webb", status: "pending" }], status: "partial", agencyId: "AG001", agencyName: "Workforce Direct" },
  ...
  { id: "ALLOC004", department: "MHE Operations", location: "Zone B", role: "MHE Operations", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "AW002", workerName: "Rico Fernandez", status: "confirmed" }, { workerId: "AW008", workerName: "Fatima Al-Hassan", status: "confirmed" }], status: "filled", agencyId: "AG001", agencyName: "Workforce Direct" },
  ...
  { id: "ALLOC006", department: "MHE Operations", location: "Zone B", role: "MHE Operations", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "AW016", workerName: "Aisha Nwosu", status: "confirmed" }], status: "partial", agencyId: "AG002", agencyName: "Pinnacle Staffing" },
  { id: "ALLOC007", department: "Outbound Dispatch", location: "Zone D", role: "Outbound Dispatch", date: "Mon 3 Feb", shift: "22:00–06:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "AW019", workerName: "Sarah Mitchell", status: "confirmed" }], status: "partial", agencyId: "AG002", agencyName: "Pinnacle Staffing" },

  // Tuesday – Pinnacle Staffing
  { id: "ALLOC008", department: "Pick and Pack", location: "Zone C", role: "Pick and Pack", date: "Tue 4 Feb", shift: "14:00–22:00", requestedHeadcount: 3, assignedWorkers: [{ workerId: "AW018", workerName: "Leon Kowalski", status: "confirmed" }, { workerId: "AW022", workerName: "Maisie O'Brien", status: "confirmed" }], status: "partial", agencyId: "AG002", agencyName: "Pinnacle Staffing" },
  ...
  { id: "ALLOC010", department: "Pick and Pack", location: "Zone C", role: "Pick and Pack", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "AW032", workerName: "Tom Brady", status: "confirmed" }, { workerId: "AW037", workerName: "Sarah Mitchell", status: "confirmed" }], status: "filled", agencyId: "AG003", agencyName: "Meridian Recruitment" },
  { id: "ALLOC011", department: "MHE Operations", location: "Zone B", role: "MHE Operations", date: "Tue 4 Feb", shift: "14:00–22:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "AW033", workerName: "Emma Johansson", status: "confirmed" }], status: "partial", agencyId: "AG003", agencyName: "Meridian Recruitment" },
