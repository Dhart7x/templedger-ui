...
export const allocations: Allocation[] = [
  // Monday
  { id: "ALLOC001", department: "Warehouse Operative", location: "Zone A", role: "Warehouse Operative", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 4, assignedWorkers: [{ workerId: "W001", workerName: "Sarah Mitchell", status: "confirmed" }, { workerId: "W003", workerName: "Maria Santos", status: "pending" }], status: "partial", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC002", department: "Warehouse Operative", location: "Zone A", role: "Warehouse Operative", date: "Mon 3 Feb", shift: "14:00–22:00", requestedHeadcount: 3, assignedWorkers: [{ workerId: "W005", workerName: "Emma Wilson", status: "confirmed" }], status: "partial", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC003", department: "MHE", location: "Zone B", role: "MHE Operative", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "W002", workerName: "James Cooper", status: "confirmed" }, { workerId: "W006", workerName: "Michael Brown", status: "confirmed" }], status: "filled", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC004", department: "Warehouse Operative", location: "Zone C", role: "Warehouse Operative", date: "Mon 3 Feb", shift: "06:00–14:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "W007", workerName: "Lisa Anderson", status: "confirmed" }], status: "partial", agencyId: "AG001", agencyName: "Staffmark" },
  // Tuesday  
  { id: "ALLOC005", department: "Warehouse Operative", location: "Zone A", role: "Warehouse Operative", date: "Tue 4 Feb", shift: "06:00–14:00", requestedHeadcount: 5, assignedWorkers: [], status: "unfilled", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC006", department: "MHE", location: "Zone B", role: "MHE Operative", date: "Tue 4 Feb", shift: "06:00–14:00", requestedHeadcount: 3, assignedWorkers: [{ workerId: "W002", workerName: "James Cooper", status: "pending" }], status: "partial", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC007", department: "Warehouse Operative", location: "Zone D", role: "Warehouse Operative", date: "Tue 4 Feb", shift: "14:00–22:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "W005", workerName: "Emma Wilson", status: "confirmed" }, { workerId: "W003", workerName: "Maria Santos", status: "confirmed" }], status: "filled", agencyId: "AG001", agencyName: "Staffmark" },
  // Wednesday
  { id: "ALLOC008", department: "Warehouse Operative", location: "Zone A", role: "Warehouse Operative", date: "Wed 5 Feb", shift: "06:00–14:00", requestedHeadcount: 4, assignedWorkers: [], status: "unfilled", agencyId: "AG001", agencyName: "Staffmark" },
  { id: "ALLOC009", department: "Warehouse Operative", location: "Zone C", role: "Warehouse Operative", date: "Wed 5 Feb", shift: "14:00–22:00", requestedHeadcount: 2, assignedWorkers: [], status: "unfilled", agencyId: "AG001", agencyName: "Staffmark" },
  // Multi-agency allocations
  { id: "ALLOC010", department: "MHE", location: "Zone A", role: "MHE Operative", date: "Mon 3 Feb", shift: "22:00–06:00", requestedHeadcount: 3, assignedWorkers: [{ workerId: "EXT001", workerName: "Alex Johnson", status: "confirmed" }, { workerId: "EXT002", workerName: "Claire Smith", status: "confirmed" }], status: "partial", agencyId: "AG002", agencyName: "Elite Staffing" },
  { id: "ALLOC011", department: "Warehouse Operative", location: "Zone B", role: "Warehouse Operative", date: "Tue 4 Feb", shift: "22:00–06:00", requestedHeadcount: 2, assignedWorkers: [{ workerId: "EXT003", workerName: "Tom Williams", status: "confirmed" }, { workerId: "EXT004", workerName: "Nina Patel", status: "confirmed" }], status: "filled", agencyId: "AG002", agencyName: "Elite Staffing" },
];
