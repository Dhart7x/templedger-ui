...
const workers: Worker[] = [
  { id: "1", name: "John Patel", role: "Warehouse Operative", agency: "Staffline", department: "Warehouse", site: "Heathrow DC", status: "on-site", clockIn: "06:02" },
  { id: "2", name: "Maria Santos", role: "Picker", agency: "Pertemps", department: "Picking", site: "Heathrow DC", status: "on-site", clockIn: "06:00" },
  { id: "3", name: "Ahmed Khan", role: "Forklift Driver", agency: "Blue Arrow", department: "Warehouse", site: "Heathrow DC", status: "on-site", clockIn: "05:58" },
  { id: "4", name: "Lucy Brown", role: "Team Lead", agency: "Staffline", department: "Warehouse", site: "Coventry Hub", status: "on-site", clockIn: "06:01" },
  { id: "5", name: "Tomasz Nowak", role: "Warehouse Operative", agency: "Staffline", department: "Loading", site: "Heathrow DC", status: "late", clockIn: "06:45" },
  { id: "6", name: "Priya Sharma", role: "Quality Controller", agency: "Pertemps", department: "Quality", site: "Heathrow DC", status: "on-site", clockIn: "06:00" },
  { id: "7", name: "James Wilson", role: "Loader", agency: "Blue Arrow", department: "Loading", site: "Birmingham DC", status: "no-show" },
  { id: "8", name: "Fatima Ali", role: "Packer", agency: "Staffline", department: "Packing", site: "Heathrow DC", status: "on-site", clockIn: "06:03" },
  { id: "9", name: "David Chen", role: "Warehouse Operative", agency: "Staffline", department: "Warehouse", site: "Birmingham DC", status: "no-show" },
  { id: "10", name: "Sophie Taylor", role: "Picker", agency: "Pertemps", department: "Picking", site: "Coventry Hub", status: "on-site", clockIn: "05:55" },
];
      ...
      <div className="flex gap-2 mb-6">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
            filter === "all" ? "bg-primary text-primary-foreground" : "bg-card border border-border"
          }`}
        >
          All ({workers.length})
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 ${
            filter === "on-site" ? "bg-primary text-primary-foreground" : "bg-card border border-border"
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 ${
            filter === "late" ? "bg-amber-500 text-white" : "bg-card border border-border"
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 ${
            filter === "no-show" ? "bg-destructive text-destructive-foreground" : "bg-card border border-border"
          }`}
        >
