...
export const users = [
  { id: "u1", name: "Rico Fernandez", email: "usman@agency.com", role: "Admin" },
  ...
  { id: "u4", name: "Yuki Tanaka", email: "james@agency.com", role: "Ops" },
];

export const sites = [
  { id: "s1", clientId: "1", name: "Heathrow", manager: "Sarah Mitchell", slaHours: 24 },
  { id: "s2", clientId: "2", name: "Coventry Hub", manager: "James Okafor", slaHours: 24 },
  { id: "s3", clientId: "3", name: "Birmingham DC", manager: "Sarah Mitchell", slaHours: 48 },
  { id: "s4", clientId: "4", name: "Leicester", manager: "Yuki Tanaka", slaHours: 24 },
  { id: "s5", clientId: "5", name: "Leeds", manager: "Diane Foster", slaHours: 24 },
];
