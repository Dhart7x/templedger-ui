...
const initialBookings: Booking[] = [
  {
    ...
    date: "Mon 10 Feb",
    status: "pending",
    suggestedAgency: "Workforce Direct",
  ...
  },
  {
    ...
    date: "Mon 10 Feb",
    status: "pending",
    suggestedAgency: "Pinnacle Staffing",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
...
const initialExceptions: LiveException[] = [
  {
    id: "exc-1",
    workerId: "w-james",
    workerName: "Daniel Reeves",
    type: "no-show",
    site: "Dallas Fort-Worth, TX",
    department: "MHE Operations",
    agency: "Meridian Recruitment",
    shift: "06:00–14:00",
    ...
    setBookings((prev) =>
      prev.map((b) => {
        if (b.id === bookingId) {
          ...
          if (status === "accepted") {
            updated.agency = "Workforce Direct";
          }
          return updated;
        }
        return b;
