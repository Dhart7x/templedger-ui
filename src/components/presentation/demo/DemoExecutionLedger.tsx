...
const workers = [
  ...
  { id: "W018", name: "Ethan Wright", department: "Production", agency: "Workforce Direct" },
  ...
  { id: "W023", name: "Amelia Foster", department: "Production", agency: "Workforce Direct" },
  ...
  { id: "W029", name: "Jessica Green", department: "Production", agency: "Workforce Direct" },
  { id: "W030", name: "Thomas King", department: "Production", agency: "Reed" },
  
  // Logistics workers
  { id: "W003", name: "Michael Brown", department: "Logistics", agency: "Adecco" },
  { id: "W031", name: "Ella Baker", department: "Logistics", agency: "Workforce Direct" },
  ...
  { id: "W036", name: "Leo Phillips", department: "Logistics", agency: "Workforce Direct" },
  ...
  { id: "W042", name: "Finn Edwards", department: "Logistics", agency: "Workforce Direct" },
...
const getExecutionSteps = (workerId: string): ExecutionStep[] => {
  ...
  const baseSteps: ExecutionStep[] = [
    { id: 1, label: "Worker registered", icon: UserPlus, status: "verified", timestamp: "Jan 15, 09:00", source: "Agency Portal", responsible: "Workforce Direct" },
