        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {criticalIssues.map((issue) => (
              <div key={issue.id} className="bg-card border border-destructive/30 rounded-lg p-4">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {warningIssues.map((issue) => (
              <div key={issue.id} className="bg-card border border-amber-500/30 rounded-lg p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <span className="text-sm font-semibold text-foreground">{issue.workerName}</span>
                    <span className="text-xs text-muted-foreground ml-2">{issue.workerId}</span>
