  ...
  return (
    <Slide className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full md:h-full md:flex md:flex-col">
        ...
        <div className="md:flex-1 md:flex md:flex-col md:pb-2">
          {/* Ledger Chain - Different layouts for mobile vs desktop */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="mb-3 md:mt-[clamp(3rem,9vh,8rem)] md:mb-8 lg:mt-[clamp(3.5rem,10vh,9rem)] lg:mb-10"
          >
          ...
          <motion.div
            ...
            className="flex justify-center md:mt-auto"
          >
